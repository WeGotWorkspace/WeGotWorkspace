...
const sheetVariants = cva(
  /* Duration/ease: `--panel-overlay-*` (SideDrawer / AppSidebar). Avoid open:500ms. */
  "ui-modal-surface fixed z-50 gap-4 bg-background shadow-lg transition duration-[var(--panel-overlay-duration)] ease-[var(--panel-overlay-ease)] data-[state=open]:animate-in data-[state=closed]:animate-out",
  {
    variants: {
      side: {
