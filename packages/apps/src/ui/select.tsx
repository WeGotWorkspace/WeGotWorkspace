...
type SelectTriggerProps = React.ComponentPropsWithoutRef<typeof SelectPrimitive.Trigger> & {
  /** Height, padding, and font-size. Radius stays `--control-radius` (parent token). Default `md` = 36px. */
  size?: ControlSize;
};
...
>(({ className, children, size = "md", ...props }, ref) => (
  ...
  >
    ...
    <SelectPrimitive.Icon asChild>
      <ChevronDown className="select-trigger__icon" aria-hidden />
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item ref={ref} className={cn("select-ui__item", className)} {...props}>
    <span className="select-ui__item-indicator">
      <SelectPrimitive.ItemIndicator>
        <Check className="select-ui__item-check" />
      </SelectPrimitive.ItemIndicator>
    </span>
