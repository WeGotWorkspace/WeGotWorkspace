...
- **Contacts and tasks are not behind the envelope** — calendars only. Expanding the envelope to contacts (RFC 9610), real blobs (RFC 8620 §6), tasks (draft-ietf-jmap-tasks-06, pinned), files (draft-ietf-jmap-filenode-14), and phased mail (RFC 8621) is planned in [.agents/specs/000-jmap-envelope-multidomain/](../../../.agents/specs/000-jmap-envelope-multidomain/spec.md) (draft roadmap; issues not yet filed).
