...
- **Notes left Drive:** FileNode no longer projects a `note` object. Notes are CalDAV VJOURNAL (`/notes/*`). See [notes-vjournal-breaking.md](../../../apps/docs/notes-vjournal-breaking.md).
