...
| `prefersReducedMotion` | `"reduce"` in Storybook preview | Capture emulates reduced motion. `.storybook/chromatic-reduced-motion.css` collapses CSS animations so Radix menus and dialogs unmount during `play` |
