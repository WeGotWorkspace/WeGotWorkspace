...
| **Product intent** | User outcomes live in Goal issues (`type:goal`) and [docs/product/](../docs/product/); `feat/` `Source:` is Task/Epic only | Review + [verify-issue](skills/verify-issue/SKILL.md) Goal vs Task modes | [GOVERNANCE.md](../GOVERNANCE.md), [specs/README.md](specs/README.md) |
