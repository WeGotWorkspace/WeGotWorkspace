...
|----|-------|-------|-----------|--------|--------|
| chunk-f0-filenode-design | planner | plan-feature, api | [`packages/api/docs/files/jmap-filenode-design.md`](../../../packages/api/docs/files/jmap-filenode-design.md) | maintainer review of node-id index design | done — #439, awaiting review |
