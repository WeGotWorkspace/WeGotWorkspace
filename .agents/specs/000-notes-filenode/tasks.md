...
|----|---------------|-------|-----------|----------------|--------|
| `notes-filenode-index` | builder | api | `packages/api/app/Services/Jmap/FileNodes/FileNodeIndexService.php`, `packages/api/docs/files/jmap-filenode-design.md` | PHPUnit FileNode + Drive hide-`.notes`; `pnpm test:api-done-gate` | pending |
...
- Do not change `NoteMarkdownCodec` starred behavior until G.
