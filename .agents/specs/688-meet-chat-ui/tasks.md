...
| `shell-channels`    | builder (this phase) | workspace                             | `MeetCallWorkspace` rename; `MeetWorkspace`; channel dialog; `Shared/Meet` story               | targeted Vitest + stories compile             | done    |
