...
| `shell-channels`    | builder (this phase) | workspace                             | `MeetCallWorkspace` rename; `MeetWorkspace`; channel dialog; `Features/Meet` story               | targeted Vitest + stories compile             | done    |
| `chat-primitives`   | later                | apps-ui, storybook                    | `packages/apps/src/chat-ui/`                                                                 | Vitest + `UI/Patterns/Chat/*` stories              | done    |
