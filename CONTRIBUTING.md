...
| **Ideas / feature requests / Goals** | **Closed** until the legal entity / CLA exists |
| **Code contributions (PRs from outside maintainers)** | **Closed** until CLA |

Do not open issues to propose product Goals or large features yet. Discussions exist for eventual intake; they are **not** announced as a community hub until maintainers deliberately open that phase.
...
Be respectful. Harassment and bad-faith reports are not welcome. A fuller CoC may land with the legal entity.
